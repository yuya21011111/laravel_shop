      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 bg-white border-b border-gray-200">
                  <div class="md:flex md:justify-around">
                      ...
                      <div class="md:w-1/2 ml-4"> 
                          ...
                          <div class="flex justify-around items-center">
                              ...
                              <form class="flex justify-around" method="post" action="{{ route('user.cart.add') }}">
                                  @csrf
                  ...
                  <div class="mb-4 text-center">
                      <button data-micromodal-trigger="modal-1" href="javascript:;" type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップ詳細</button>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
          ...
          <footer class="modal__footer">
            <button type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded modal__btn" data-micromodal-close aria-label="Close this dialog window">閉じる</button>
          </footer>
        </div>
      </div>
  </div>
